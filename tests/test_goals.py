...
@pytest.mark.asyncio
async def test_no_permission_create_goal(client: AsyncClient):
    payload = {
        "title": "Test Goal",
...
# @pytest.mark.asyncio
# async def test_create_goal(client: AsyncClient, token_user1: models.Token):
#     headers = {
...
# @pytest.mark.asyncio
# async def test_no_permission_read_goals(client: AsyncClient, goal_user1: models.Goal):
#     response = await client.get(f"/goals/{goal_user1.goal_id}")
#     assert response.status_code == 401

# @pytest.mark.asyncio
# async def test_read_goals(client: AsyncClient, token_user1: models.Token, goal_user1: models.Goal):
#     headers = {
#         "Authorization": f"{token_user1.token_type} {token_user1.access_token}"
#     }
...
#     assert "goal_id" in data
#     assert data["goal_id"] == goal_user1.goal_id  # Ensure the right goal is returned

# @pytest.mark.asyncio
# async def test_no_permission_update_goals(client: AsyncClient, goal_user1: models.Goal):
#     payload = {
#         "title": "Updated Goal",
...
# @pytest.mark.asyncio
# async def test_update_goals(client: AsyncClient, token_user1: models.Token, goal_user1: models.Goal):
#     headers = {
#         "Authorization": f"{token_user1.token_type} {token_user1.access_token}"
#     }
#     payload = {
...
#     response = await client.put(f"/goals/{goal_user1.goal_id}", json=payload, headers=headers)
#     data = response.json()
...
# @pytest.mark.asyncio
# async def test_no_permission_delete_goals(client: AsyncClient, goal_user1: models.Goal):
#     response = await client.delete(f"/goals/{goal_user1.goal_id}")
#     assert response.status_code == 401

# @pytest.mark.asyncio
# async def test_delete_goals(client: AsyncClient, token_user1: models.Token, goal_user1: models.Goal):
#     headers = {
#         "Authorization": f"{token_user1.token_type} {token_user1.access_token}"
#     }
...
#     assert response.status_code == 200
#     assert data.get("detail") == "Goal deleted successfully"  # Assuming the API returns a success message
